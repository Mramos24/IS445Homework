<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm.aspx.cs" Inherits="_445CourseProject.Demo" %>


<asp:Content ID="Content1" runat="server" 
    contentplaceholderid="ContentPlaceHolder1">
    <h2>Welcome to my Web Form</h2>
  <p>A demo form for hotel reservations</p>      
       <Fieldset >
...
<button type="reset">Clear Form</button><button type="submit">Request Reservation</button></p>
 &nbsp;&nbsp;
</asp:Content>
